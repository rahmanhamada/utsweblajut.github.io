<?php 
	...
	if(empty($nim)){
	header("Location:index.php?include=tambah_mahasiswa&notif=tambahkosong&jenis=nim");
	}else if(empty($nama)){
	header("Location:index.php?include=tambah_mahasiswa&notif=tambahkosong&jenis=nama");
	}else if(empty($kode_jurusan)){
	header("Location:index.php?include=tambah_mahasiswa&notif=tambahkosong&data=jurusan");
	}else{
	...
	header("Location:index.php?include=mahasiswa&notif=tambahberhasil");
	}
?>
