...
?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="index.php?include=mahasiswa">Data Mahasiswa</a></li>
	...
	enctype="multipart/form-data" action="index.php?include=konfirmasi_edit_mahasiswa">
	<div class="card-body">
